...
$('document').ready(function () {
	...
	$('#turn_on').click(function () {
		...
		$('#b55').animate({ top: 190, left: 300 }, 500);
		$('#b66').animate({ top: 190, left: 380 }, 500);
		$('#b77').animate({ top: 190, left: 460 }, 500);
		$('#b88').animate({ top: 190, left: 540 }, 500);
		$('#b99').animate({ top: 190, left: 620 }, 500);
